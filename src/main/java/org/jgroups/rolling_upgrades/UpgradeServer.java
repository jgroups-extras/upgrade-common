...
public class UpgradeServer {
    ...
    public void start(int port, String cert, String private_key, boolean verbose) throws Exception {
        ServerBuilder<?> srv_builder=ServerBuilder.forPort(port)
          .addService(new UpgradeService().verbose(verbose));
    ...
    protected static void help() {
        System.out.println("UpgradeServer [-port <server port>] [-cert cert-file] " +
                             "[-key private-key-file] [-v]\n" +
